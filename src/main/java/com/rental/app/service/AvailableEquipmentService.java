...
public class AvailableEquipmentService {
   ...
   */
  public AvailableEquipment updateAvailableEquipment(Long id,
                                                     AvailableEquipment availableEquipmentDetails) {
    ...
    if (!oldPointId.equals(newPointId) || !oldTypeId.equals(newTypeId)) {
      if (availableEquipmentRepository.existsByRentalPointIdAndEquipmentTypeId
        (newPointId, newTypeId)) {
        throw new IllegalArgumentException
          ("Этот тип инвентаря уже добавлен в данный пункт проката.");
      }
    }
   ...
   */
  public Optional<AvailableEquipment> getEquipmentByPointAndType(Long rentalPointId,
                                                                 Long equipmentTypeId) {
    return availableEquipmentRepository.findByRentalPointIdAndEquipmentTypeId
      (rentalPointId, equipmentTypeId);
  }
  ...
  public void rentEquipment(Long equipmentId, int quantity) {
    AvailableEquipment equipment = availableEquipmentRepository.findById(equipmentId)
      .orElseThrow(() -> new RuntimeException("Запись инвентаря с ID: " +
        equipmentId + " не найдена."));
